...
to_kill_a_mockingbird = media.Movie("To Kill a Mockingbird",
                                    ...
                                    "http://upload.wikimedia.org/wikipedia/en/8/8e/To_Kill_a_Mockingbird_poster.jpg",
                                    "https://www.youtube.com/watch?v=KR7loA_oziY")

johnny_got_his_gun = media.Movie("Johnny Got His Gun",
                                 1971,
                                 "A young American soldier (Joe) in WW I is wounded by a landmine. He loses his arms, legs and eyes as well as his ability to hear, speak or smell. Lying in hospital, he is not able to distinguish if he is awake or if he is dreaming. Trying to find out, he relives his story in strange dreams and memories.",
...
blazing_saddles = media.Movie("Blazing Saddles",
                              ...
                              "http://upload.wikimedia.org/wikipedia/en/thumb/7/7b/Blazing_saddles_movie_poster.jpg/225px-Blazing_saddles_movie_poster.jpg",
...
naked_gun = media.Movie("The Naked Gun",
                        ...
                        "http://upload.wikimedia.org/wikipedia/en/thumb/5/5f/The_Naked_Gun_Poster.jpg/220px-The_Naked_Gun_Poster.jpg",
                        "https://www.youtube.com/watch?v=PACTQutbow4")

glory = media.Movie("Glory",
                    1989,
                    "Robert Gould Shaw leads the US Civil War's first all-black volunteer company, fighting prejudices of both his own Union army and the Confederates.",
                    "https://upload.wikimedia.org/wikipedia/en/e/e6/Glory_ver1.jpg",
...
schindlers_list = media.Movie("Schindler's List",
                              ...
                              "http://upload.wikimedia.org/wikipedia/en/thumb/3/38/Schindler%27s_List_movie.jpg/220px-Schindler%27s_List_movie.jpg",
                              "https://www.youtube.com/watch?v=JdRGC-w9syA")

# generate HTML file based on movie objects above and open in a web browser
fresh_tomatoes.open_movies_page([to_kill_a_mockingbird, johnny_got_his_gun, blazing_saddles, airplane, top_gun, naked_gun, glory, unforgiven, schindlers_list])